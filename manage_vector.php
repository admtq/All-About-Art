...
if (isset($_GET['delete'])) {
    ...
    header("Location: manage_vector.php");
}
...
// Ambil semua data
$result = $db->query("SELECT post.id_post, post.name_post, post.caption_post, post_media.media_file FROM post_media INNER JOIN post ON post_media.id_post=post.id_post WHERE media_file LIKE '%vector%'");
?>
        ...
        <tbody>
            <?php while ($row = $result->fetch_assoc()): ?>
                <tr>
                    ...
                    <td><img src="AllAboutArtv2/dbpost/dbvector/<?php echo $row['media_file']; ?>" alt="<?php echo $row['name_post']; ?>" style='width: 300px;'></td>
                    <td>
