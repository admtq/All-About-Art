    ...
    <section class="order-details">
        <div class="order-container">
            ...
            <div class="popup-content">
                ...
                <form action="vector_view.php?id_post=<?php echo htmlspecialchars($id_post); ?>" method="POST">
    <button type="submit" name="submit">Selesai</button>
</form>
            ...
            <?php if (!empty($view['media_file'])): ?>
                <div class="image-container">
                    <img src="dbpost/dbvector/<?php echo htmlspecialchars($view['media_file']); ?>" alt="Gambar Postingan" />
                </div>
            <?php else: ?>
