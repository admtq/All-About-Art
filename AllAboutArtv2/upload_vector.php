...
if (isset($_POST['submit'])) {
    ...
    $filename = "vector_" . $_FILES['file']['name'];
    $tmpname = $_FILES['file']['tmp_name'];
    $folder = 'dbpost/dbvector/' .$filename;
...
<body>
    ...
    <h2>Posting Vector</h1>
    <form action="upload_vector.php" method="POST" enctype="multipart/form-data">
