<?php
    ...
    if (isset($_POST['search_query']) && !empty($_POST['search_query'])) {
        ...
        $sql = "SELECT * FROM post_media WHERE media_file LIKE '%animasi%'";
    }
    ...
    <section class="gallery-section">
        ...
        <div class="gallery" id="gallery">
            ...
            <div class="gallery-item">
                <a href="animasi_view.php?id_post=<?php echo $row['id_post']; ?>"> <!-- Link ke halaman view -->
                    <video controls class="video">
                        <source src="dbpost/dbanimasi/<?php echo $row['media_file']; ?>">
