...
if (isset($_POST['submit'])) {
    ...
    $filename = "animasi_" . $_FILES['file']['name'];
    $tmpname = $_FILES['file']['tmp_name'];
    $folder = 'dbpost/dbanimasi/' .$filename;
...
<body>
    ...
    <h2>Posting Animasi</h1>
    <form action="upload_animasi.php" method="POST" enctype="multipart/form-data">
