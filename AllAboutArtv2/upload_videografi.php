...
if (isset($_POST['submit'])) {
    ...
    $filename = "videografi_" . $_FILES['file']['name'];
    $tmpname = $_FILES['file']['tmp_name'];
    $folder = 'dbpost/dbvideografi/' .$filename;
...
<head>
    ...
    <title>Posting Videografi</title>
</head>
<body>
    <!-- Header -->
    <header>
    ...
    <h2>Posting Videografi</h1>
    <form action="upload_videografi.php" method="POST" enctype="multipart/form-data">
        ...
        <div id="drop-area">
            ...
            <input type="file" id="file" name="file" accept=".mp4, .webm" required style="display: none;">
        </div>
