<?php
    ...
    if(isset($_POST['signup'])) {
        ...
        $sql = "INSERT INTO  users_app (name_user, username, password) VALUES ('$name', '$username', '$password')";

        if($db->query($sql)) {
            header("location: login.php");
        } else {
            $signup_message = "Daftar gagal, silahkan coba lagi";
        }
    }
?>
    ...
    <section class="login">
        <div class="login-form">
            ...
            <form action="register.php" method="POST">
                <input type="text" name="name_user" placeholder="Nama" required>
