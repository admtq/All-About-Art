<?php
    ...
    if (isset($_POST['search_query']) && !empty($_POST['search_query'])) {
        ...
        $sql = "SELECT * FROM post_media WHERE media_file LIKE '%vector%'";
    }
    ...
    <section class="gallery-section">
        ...
        <div class="gallery" id="gallery">
            ...
            <div class="gallery-item">
                <a href="vector_view.php?id_post=<?php echo $row['id_post']; ?>"><img src="dbpost/dbvector/<?php echo $row['media_file']; ?>" alt="<?php echo $row['media_file']; ?>"></a>
                <div class="buttons">
                </div>
            </div>
            <?php
