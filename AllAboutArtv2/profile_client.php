...
if (isset($_GET['id_users_app'])) {
    $id_users = intval($_GET['id_users_app']);
    $sql = "SELECT * FROM users_app WHERE id_users_app = $id_users";
...
<head>
    ...
    <title>Lihat Profil - <?php echo $view_profile['name_user'] ?></title>
</head>
<body>
    <header>
        <nav>
    ...
    <div class="profile-container">
        <div class="profile-header">
            <div class="profile-pic">
                <img src="<?php echo $view_profile['foto_user'] ?: 'profileusers/default.png' ?>" alt="Profile">
            </div>
            <div class="profile-info">
                <h2 class="username"><?php echo $view_profile['name_user'] ?></h2>
                <div class="profile-bio">
                    <p>"<?php echo $view_profile['description_user'] ?>"</p>
                </div>
                <a href="https://wa.me/62<?php echo $view_profile['notelepon'] ?>"><button class="edit-profile-btn">Kirim Pesan</button></a>
            </div>
        </div>
        ...
        <div class="gallery" id="gallery">
            ...
            $query = "
                ...
                WHERE post.created_by_user_id = '$id_users'
            ";
            ...
            ?>
                <div class="gallery-item">
                    ...
                    <?php if (preg_match('/^fotografi_/i', $row['media_file'])) { ?>
                        <a href="fotografi_view.php?id_post=<?php echo $row['id_post']; ?>">
                    ...
                    <?php } if (preg_match('/^videografi_/i', $row['media_file'])) { ?>
                        <a href="videografi_view.php?id_post=<?php echo $row['id_post']; ?>">
                    ...
                    <?php } if (preg_match('/^vector_/i', $row['media_file'])) { ?>
                        <a href="vector_view.php?id_post=<?php echo $row['id_post']; ?>">
